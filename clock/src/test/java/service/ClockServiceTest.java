...
//        System.out.println("初始化操作done。");
        ...
        void setByPhoneTimeTest() {
            ...
            assertEquals(dateTime.minusHours(7),hotel.getClocks().get(1).getDate());
            assertEquals(dateTime.minusHours(5),hotel.getClocks().get(2).getDate());
            assertEquals(dateTime.minusHours(12),hotel.getClocks().get(3).getDate());
            assertEquals(dateTime.plusHours(2),hotel.getClocks().get(4).getDate());
        }
}
